...
# %% ../../nbs/api/pymor/parameters.ipynb #e86d8e15-a853-43ee-a73c-03045738293e
...
# %% ../../nbs/api/pymor/parameters.ipynb #a0d3a627-a8fc-4524-b1ea-6b60e8b7a684
@patch
...
# %% ../../nbs/api/pymor/parameters.ipynb #ca8552af-7367-467b-a854-7aa9288d1a9a
@patch
def __str__(self:ParameterFunctional):
    return f'f({", ".join(self.parameters)})'

# %% ../../nbs/api/pymor/parameters.ipynb #c6f7eeb6-269b-47f4-bcf1-94cde8f87a10
...
# %% ../../nbs/api/pymor/parameters.ipynb #3b5f3a85-f306-4524-9bf2-564b6252dd3d
