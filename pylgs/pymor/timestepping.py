...
# %% auto #0
__all__ = ['NoSundialsError', 'init_progress_widget', 'tick', 'update_progress_widget', 'init_cvode', 'solve_cvode',
           'AdamsTimeStepper', 'BDFTimeStepper', 'StiffSwitchingTimeStepper']

# %% ../../nbs/api/pymor/timestepping.ipynb #89f52a9a
class NoSundialsError(ImportError):
    def __init__(self, message="scikits.odes.cvode not found, please install scikits.odes to use the cvode time stepper."):
        super().__init__(message)

# %% ../../nbs/api/pymor/timestepping.ipynb #063c5c9c
import time
...
# %% ../../nbs/api/pymor/timestepping.ipynb #d9dab3f5
try:
...
# %% ../../nbs/api/pymor/timestepping.ipynb #ed09d3e4
@patch
...
# %% ../../nbs/api/pymor/timestepping.ipynb #756050ca
...
# %% ../../nbs/api/pymor/timestepping.ipynb #c97f60f7
def tick(): return time.time() * 1000

# %% ../../nbs/api/pymor/timestepping.ipynb #e95a71c5
...
# %% ../../nbs/api/pymor/timestepping.ipynb #0938388b
...
# %% ../../nbs/api/pymor/timestepping.ipynb #b514f7a8
...
# %% ../../nbs/api/pymor/timestepping.ipynb #6049d750
