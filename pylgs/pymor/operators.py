...
# %% ../../nbs/api/pymor/operators.ipynb #17eb0631-33d0-4b1c-bfb8-b7cc43487310
...
# %% ../../nbs/api/pymor/operators.ipynb #6f156a13-dd80-453a-9461-6c60d8203fc9
LincombOperator.suboperator_symbol = '+'

# %% ../../nbs/api/pymor/operators.ipynb #4c2e838e-53a3-41a0-a56d-817281753733
...
# %% ../../nbs/api/pymor/operators.ipynb #28d6c2f7-3989-46f6-bc5c-313a91763861
...
# %% ../../nbs/api/pymor/operators.ipynb #5d643bab-2a12-4abd-9d0e-0983023df9d5
...
# %% ../../nbs/api/pymor/operators.ipynb #9608c05e-3e94-4d45-aa8b-e28b33619668
...
# %% ../../nbs/api/pymor/operators.ipynb #e4efa573-d6f2-4b01-bbcd-581d850fe9f0
@patch
def _repr_html_(self:Operator):
    return operator_html_tree(self)

# %% ../../nbs/api/pymor/operators.ipynb #78e2dd1c-fbd6-466d-bb3f-779771041435
...
# %% ../../nbs/api/pymor/operators.ipynb #48660ea3-13e6-4712-947f-7085aee56ead
def _ndims(matrix):
...
# %% ../../nbs/api/pymor/operators.ipynb #b70db73e-0d27-49a9-ad15-7887ed1bbf6d
...
# %% ../../nbs/api/pymor/operators.ipynb #5f8c6e69-3c6f-47ce-ab0c-eb988ced9ceb
...
# %% ../../nbs/api/pymor/operators.ipynb #a951bee6-6720-4249-8d4b-8d6e60a7f21f
...
# %% ../../nbs/api/pymor/operators.ipynb #e3ecaabb-6fbd-477c-8295-4fd46f55d9db
...
# %% ../../nbs/api/pymor/operators.ipynb #acc80f1f-a83a-40ba-bb1c-e98126d331e7
def coordinates_to_list(coords, dims):
    return [(d, coords[d].data, coords[d].attrs) for d in dims]

# %% ../../nbs/api/pymor/operators.ipynb #a7c8aabe-93ac-46dd-936b-09c72bec2124
...
# %% ../../nbs/api/pymor/operators.ipynb #ce847cd9-6c21-4e03-a504-bff9d5eceaee
...
# %% ../../nbs/api/pymor/operators.ipynb #67fbd818-5ed6-4051-993c-520784cf75d3
@patch(as_prop=True)
...
# %% ../../nbs/api/pymor/operators.ipynb #401555e5-ced7-408a-854d-dc9743035fa5
...
# %% ../../nbs/api/pymor/operators.ipynb #a29550d4-6d6d-4edc-8d8b-cd1dcf727e66
def dims_matvec(a, b):
...
# %% ../../nbs/api/pymor/operators.ipynb #a4e4c9e8-a292-4cd9-8a67-ea6c93d759b4
@patch
...
# %% ../../nbs/api/pymor/operators.ipynb #5c0d92c5-5bc7-41dd-ba16-725671c57781
def replace_item(dct, old_key, new_pair):
    return dict(new_pair if k == old_key else (k, v) for k,v in dct.items())

# %% ../../nbs/api/pymor/operators.ipynb #75a9a43a-c131-4289-89c6-0950e11c7c5d
@patch
...
# %% ../../nbs/api/pymor/operators.ipynb #0fa4976c-0e61-4d38-b570-cc02a54e7c25
@patch
def apply(
...
# %% ../../nbs/api/pymor/operators.ipynb #dae0a068-c60d-47f0-874d-e204df93c08e
@patch
def apply_adjoint(
    self:XarrayMatrixOperator, 
...
# %% ../../nbs/api/pymor/operators.ipynb #32de9fdf-8d39-491e-8877-bdbf5da5825b
@patch
...
# %% ../../nbs/api/pymor/operators.ipynb #430d5b9a-28f5-460f-9aac-98958622b3a8
...
# %% ../../nbs/api/pymor/operators.ipynb #c45bf655-9d7b-4e34-adf5-03224d3ba83a
@patch
def to_numpy(self:XarrayMatrixOperator):
    """Return the operator in dense `ndarray` format."""
    return self.matrix.to_numpy()

# %% ../../nbs/api/pymor/operators.ipynb #b17e1229-576c-4339-b964-5c2f70effe0d
...
# %% ../../nbs/api/pymor/operators.ipynb #f7e316d2-fe64-4095-b178-a0d892d3fc39
def densify(
...
# %% ../../nbs/api/pymor/operators.ipynb #d9c93fff
...
# %% ../../nbs/api/pymor/operators.ipynb #87ba7c35-ea66-405e-bb00-353f8caf35e3
...
# %% ../../nbs/api/pymor/operators.ipynb #d5057a01-74c7-4cbe-963c-b986527d9752
...
# %% ../../nbs/api/pymor/operators.ipynb #bc1b1a9c-2fb2-487e-a585-b15cc2337faa
@patch
...
# %% ../../nbs/api/pymor/operators.ipynb #6727a27d-3e62-4192-bf9c-d7ec9c97fee0
def _numpy_zero_operator(shape):
    return ZeroOperator(*[NumpyVectorSpace(dim) for dim in shape])

# %% ../../nbs/api/pymor/operators.ipynb #dec9308a-2fbd-4c33-a4a4-d12d7407be15
...
# %% ../../nbs/api/pymor/operators.ipynb #5bac8509-f0df-4626-8adf-4008fdd12f28
...
# %% ../../nbs/api/pymor/operators.ipynb #eadff473-5be9-4b4b-9e8d-df0da72a94ef
@patch
...
# %% ../../nbs/api/pymor/operators.ipynb #5f69f7f8-8db5-42cb-b769-d213fd1845b4
@patch
...
# %% ../../nbs/api/pymor/operators.ipynb #0acdce6f-2cb6-4aa8-a2dd-12162a4d6c8e
@patch
...
# %% ../../nbs/api/pymor/operators.ipynb #8360dac3-cfb5-47e4-afda-98678c5df6e2
@patch(as_prop=True)
def terms(self:LincombOperator):
    return [c * o for c, o in zip(self.coefficients, self.operators)]

# %% ../../nbs/api/pymor/operators.ipynb #05c9d798-128d-4f11-9bfa-d93320b9660c
...
# %% ../../nbs/api/pymor/operators.ipynb #ed1fd1ea-160e-40c6-830e-0e930ac19748
@patch
...
# %% ../../nbs/api/pymor/operators.ipynb #ea50e807-148f-407b-8882-a071ca1975b1
@patch
def __str__(self:ProductOperator):
    return ' ⨂ '.join(str(o) for o in self.operators)

# %% ../../nbs/api/pymor/operators.ipynb #5d30eff4-b40c-4d6f-bf91-867bd2190892
@patch
def __str__(self:IdentityOperator):
    return f'I{_mapping_str(self)}'

# %% ../../nbs/api/pymor/operators.ipynb #df8c1290-a2fe-4f78-87a9-64f250d19ee1
@patch
...
# %% ../../nbs/api/pymor/operators.ipynb #489f0dcc-43b9-4727-aadd-c41392c3835e
@patch(as_prop=True)
def H(self:ProductOperator):
    return self.with_(operators=[op.H for op in self.operators])

# %% ../../nbs/api/pymor/operators.ipynb #d4526f0e-1179-4e1a-9b6f-f5189e3611b9
@patch
def apply_adjoint(self:ProductOperator, V, mu=None):
    return self.H.apply(V, mu=mu)

# %% ../../nbs/api/pymor/operators.ipynb #a6aa37e5-a509-4978-9968-c0ebe597ea66
@patch
...
# %% ../../nbs/api/pymor/operators.ipynb #3259ccd2-481c-465d-8584-6022e3625f13
...
# %% ../../nbs/api/pymor/operators.ipynb #06a1a731-0014-4720-ad0d-f25e9f42a617
...
# %% ../../nbs/api/pymor/operators.ipynb #e92e0242-11d4-4e10-9b27-5403e9bb9d4f
@match_class(ProductOperator)
...
# %% ../../nbs/api/pymor/operators.ipynb #3b39453b-3e45-4acb-b1c0-a173ba10045d
@match_class(ProductOperator)
...
# %% ../../nbs/api/pymor/operators.ipynb #71d33245-7737-4278-96a9-dd73a4d61094
@patch
def as_source_array(self:ProductOperator, mu=None):
    return contract(self.assemble(mu)).as_source_array()

# %% ../../nbs/api/pymor/operators.ipynb #7ca4a7f9-0e2e-4513-88d9-ddd1cca30018
@patch
